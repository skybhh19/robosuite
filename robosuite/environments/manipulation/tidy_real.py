...
class TidyReal1(SingleArmEnv):
    ...
    def __init__(
        ...
        self.num_objs = 4
        self.left_bin_obj_ids = [1, 2, 3]
        self.right_bin_obj_ids = []
        self.left_mat_obj_ids = [0]
        self.right_mat_obj_ids = []
...
class TidyReal2(SingleArmEnv):
    ...
    def __init__(
        ...
        self.num_objs = 4
        self.left_bin_obj_ids = [1, 2]
        self.right_bin_obj_ids = [3]
        self.left_mat_obj_ids = []
        self.right_mat_obj_ids = [0]
...
class TidyReal3(SingleArmEnv):
    ...
    def __init__(
        ...
        self.num_objs = 4
        self.left_bin_obj_ids = [1]
        self.right_bin_obj_ids = [2]
        self.left_mat_obj_ids = [0]
        self.right_mat_obj_ids = [3]
