...
def trial(a,m,e,version,regime):
 ...
 try:
  if a.kind=='threading':
   ...
   from robosuite.scripts.collect_tool_hang_wrench_joint import GeometricJointPolicy,ROBUST_JOINT_OPTIONS,THREADING_STYLE_JOINT_OPTIONS,VideoRecorder,collection_acceptance
   ...
   opts.update(THREADING_STYLE_JOINT_OPTIONS if version == 'toolhang_vla_v3' else ROBUST_JOINT_OPTIONS);p=GeometricJointPolicy(**opts);p.human_enabled=version!='baseline'
